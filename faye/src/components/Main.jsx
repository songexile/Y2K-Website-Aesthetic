                    ...
                    <div className="h-2/6 bg-gradient-to-t from-[#000000] to-[#000000] text-white mx-2 mt-2 rounded-md y2k-shadow4 inner-stroke">
                      <div class="window-body">
                        ...
                        <div className="flex mx-4 mt-2 ">
                          Final Fantasy X[a] is a role-playing video game
                          developed and published by Square as the tenth main
                          entry in the Final Fantasy series. Originally released
                          in 2001 for PlayStation 2.
                        </div>
                      </div>
                    </div>
