      ...
      <div className="mx-auto w-full h-screen bg-slate-300 flex items-center justify-center y2k-shadow3">
        ...
        <div className=" mx-4 w-full h-screen bg-slate-300 border y2k-shadow3 ">
          ...
          <div className="flex bg-slate-500 h-[52rem] m-4  ">
            {/* Left Side */}
            <div className="w-2/3  bg-slate-500 flex flex-col ">
              ...
              <div className="h-1/6 bg-gradient-to-t from-[#8ea7aa] to-[#53686b]   mb-2 mt-4  rounded-2xl y2k-shadow4 mx-4 p-16  "></div>
            </div>
            {/* Right Side */}
            <div className="w-1/2   flex flex-col">
              <div className="h-1/6 bg-gradient-to-t from-[#cee3e5] to-[#b4cdcf] mx-2 mt-2 rounded-md y2k-shadow4 "></div>
              <div className="h-2/6 bg-gradient-to-t from-[#cee3e5] to-[#b4cdcf] mx-2 mt-2 rounded-md y2k-shadow4"></div>
